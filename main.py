...
from src.audio_devices.controllers.yamaha.tio1608_d import YamahaTio1608Controller
...
if __name__ == "__main__":
    ...
    yamaha_controller = YamahaTio1608Controller.scan_devices()
    devices = yamaha_controller.adc_devices
    # exit()
    #
    # devices = (
